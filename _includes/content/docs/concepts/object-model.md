...
A `State` may also inherit from zero or more **parastates**, from which its contents are *composed*, in a manner similar to the concepts of dynamic mixins or multiple inheritance found in other environments.
