...
var StateController = ( function () {
        ...
        function accessor () {
            ...
            if ( this === owner ) {
                ...
                return arguments.length ?
                    current.query.apply( current, arguments ) :
                    current;
            }
    ...
    StateController.privileged = {
        ...
        // 
        // * `arguments` : `Array` — arguments to be passed to a transition’s
        //   `action` function.
        // 
        ...
        change: function ( setCurrent, setTransition ) {
            ...
            return function (
                ...
                var owner, transition, targetOwner, source, origin, domain,
                    info, state, record, transitionExpression,
                    self = this;
                ...
                return transition.start.apply( transition, options.arguments )
                    || target;
            }
        }
    };
