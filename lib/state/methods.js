...
Z.assign( State.privileged, {
    ...
    // <a class="icon-link"
    //    name="state--methods--method"
    //    href="#state--methods--method"></a>
    // 
    // #### method
    // 
    ...
    // <a class="icon-link"
    //    name="state--methods--method-names"
    //    href="#state--methods--method-names"></a>
    // 
    // #### methodNames
    // 
    ...
    // <a class="icon-link"
    //    name="state--methods--add-method"
    //    href="#state--methods--add-method"></a>
    // 
    // #### addMethod
    // 
    ...
    // <a class="icon-link"
    //    name="state--methods--remove-method"
    //    href="#state--methods--remove-method"></a>
    // 
    // #### removeMethod
    // 
...
Z.assign( State.prototype, {
    ...
    // <a class="icon-link"
    //    name="state--methods--apply"
    //    href="#state--methods--apply"></a>
    // 
    // #### apply
    // 
    ...
    // corresponding inheriting state in the local controller.
    apply: function ( /*String*/ methodName, /*Array*/ args ) {
        ...
        if ( !method ) {
            return this.emit( 'nonexistent', [ methodName, args ], false );
        }
    ...
    // <a class="icon-link"
    //    name="state--methods--call"
    //    href="#state--methods--call"></a>
    // 
    // #### call
    // 
    // Variadic [`apply`](#state--methods--apply).
