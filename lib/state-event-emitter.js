...
var StateEventEmitter = ( function () {
    ...
    O.assign( StateEventEmitter.prototype, {
        ...
        // #### [once](#state-event-emitter--prototype--once)
        //
        // Creates and binds a listener that wraps the provided `fn` listener,
        // such that `fn` will be invoked just once, by the next `emit()`.
        once: function ( fn, context ) {
            ...
            return id = this.add( once, context );
        },
