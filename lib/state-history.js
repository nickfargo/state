...
var StateHistory = ( function () {
    ...
    function StateHistory ( /*State*/ state ) {
        ...
        // 
        // * a `Number` that is an **element reference** that points to a
        //   superhistory element, within which is contained the information
        //   relevant to this element;
        // 
        // * or `null`, indicating a recorded period of inactivity for
        //   `this.state`.
        this.elements = {};
    ...
    Z.assign( StateHistory.prototype, {
        ...
        indexOf: function () {
            return function ( key ) {
                return search( this.indices, key );
            };
        },

        traverseToElement: function ( /*Number*/ key ) {
            var targetIndex = search( this.indices, key );
            if ( targetIndex ) return this.traverseToIndex( targetIndex );
        },

        traverseToIndex: function ( /*Number*/ targetIndex ) {
        ...
        // additional mutations upon arriving at the targeted state.
        traverseBy: function (
             /*Number*/ nStates,
             /*Number*/ nMutations, // = 0
