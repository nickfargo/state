// <a class="icon-link"
//    name="state-event-collection"
//    href="#state-event-collection"></a>
// 
// ## StateEventCollection
// 
// A state holds event listeners for each of its various event types in a
// `StateEventCollection` instance.
// 
// An event listener is usually a function, but may also be held as a string,
// which, when the client state [`emit`](#state-event-collection--prototype--event)s
// the event type associated with this collection, will be interpreted as an
...
var StateEventCollection = ( function () {
    ...
    Z.assign( StateEventCollection.prototype, {
        ...
        // [`add`](#state-event-collection--prototype--add).
        ...
        // called when the the collection
        // [`emit`](#state-event-collection--prototype--emit)s an event.
        ...
        // [`add`](#state-event-collection--prototype--add) or a reference to
        // the function itself.
        // 
        // *Aliases:* **off unbind**
