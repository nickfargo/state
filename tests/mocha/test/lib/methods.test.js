...
(function() {
  var RootState, State, bind, env, expect, fix, state, _ref;

  _ref = state = require('../'), env = _ref.env, bind = _ref.bind, fix = _ref.fix, State = _ref.State, RootState = _ref.RootState;
  ...
  describe("Methods:", function() {
    ...
    describe("Own accessor", function() {
      return it("is created upon first invocation of inherited accessor", function() {
        var f, m, o, _ref1;
        _ref1 = setup(), o = _ref1.o, f = _ref1.f, m = _ref1.m;
    ...
    describe("Context: state-binding and state-fixing", function() {
      ...
      methods = {
        ...
        fixed: fix(function(autostate, protostate) {
          return function() {
            return this;
          };
        }),
        both: fix(function(autostate, protostate) {
    ...
    return describe("Destroying an object’s entire state tree", function() {
