...
var State = ( function () {
	 ...
	 * protostates, it possesses few properties of its own, and requires far fewer enclosed
	 * resources compared to a "real" State instance.
	 */
	...
	function createDelegate ( methodName, controllerName ) {
		/**
		...
		addMethod: function ( methods ) {
			...
			return function ( methodName, fn ) {
				...
				if ( !this.method( methodName, true, false ) ) {
					 ...
					 */
					owner[ methodName ] = createDelegate( methodName, controller.name() );
				}
