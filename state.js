(function(e){if("function"==typeof bootstrap)bootstrap("state",e);else if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else if("undefined"!=typeof ses){if(!ses.ok())return;ses.makeState=e}else"undefined"!=typeof window?window.state=e():global.state=e()})(function(){var define,ses,bootstrap,module,exports;
...
(function() {
  ...
  module.exports = State = (function() {
    var ABSTRACT, ABSTRACT_OR_CONCRETE, ATOMIC, CONCLUSIVE, CONCRETE, CONCURRENT, DEFAULT, DESTROYED, FINAL, FINITE, HISTORY, IMMUTABLE, INCIPIENT, INCIPIENT_OR_MUTABLE, INCIPIENT_OR_VIRTUAL, INITIAL, MUTABLE, MUTABLE_OR_FINITE, NIL, NORMAL, PROTO_HERITABLE_ATTRIBUTES, REFLECTIVE, RETAINED, SHALLOW, STATIC, VIA_ALL, VIA_NONE, VIA_PROTO, VIA_SUB, VIA_SUPER, VIRTUAL, assign, clone, createDispatcher, delta, edit, env, flatten, has, hasOwn, isArray, isEmpty, lookup, memoizeProtostates, useDispatchTables, _ref, _ref1, _ref2;
    ...
    State.prototype.realize = function(expression) {
      var attributes, key, method, name, ss, substates, _base, _ref3;
      ...
      if (attributes & VIRTUAL) {
        if (ss = this.superstate) {
          ...
          substates = (_base = ss._).substates || (_base.substates = {});
          if (substates[name]) {
...
},{"./state-function":2,"./state-content":9,"./state-expression":4,"./state-event-emitter":10,"./transition-expression":7,"omicron":11}],9:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
(function() {
...
},{"./state-function":2}],10:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
(function() {
    ...
    interpret = function(map) {
      ...
      for (key in map) {
        ...
        if (category) {
          ...
          item[key] = value;
        } else if ((categoryMap[key] != null) && value) {
          result[key] = clone(result[key], value);
        } else {
...
(function(){// Copyright (C) 2011-2013
